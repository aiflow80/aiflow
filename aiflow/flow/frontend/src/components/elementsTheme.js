...
const ElementsTheme = ({ children, theme }) => {
  ...
  const elementsTheme = useMemo(() => {
    return createThemeWithColors(themeSettings.base, themeSettings.customColors);
  }, [themeSettings.base, themeSettings.customColors]);
  ...
  }, [theme]); // Remove themeConfig.defaultMode from dependencies

  const contextValue = useMemo(() => ({
    theme: elementsTheme,
    mode: themeSettings.base,
    updateTheme: setThemeSettings
  }), [elementsTheme, themeSettings.base]);
